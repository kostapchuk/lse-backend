...
class UserController(private val userService: UserService) {
    ...
    fun save(@Valid @RequestBody userRequest: UserRequest) = userService.save(userRequest)

    @PutMapping("/{id}")
    fun updateById(@Valid @PathVariable id: String, userRequest: UserRequest) = userService.updateById(id, userRequest)
